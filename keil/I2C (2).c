...
// Wait until the I2C controller finishes the current transaction.
 ...
 */
// Configure I2C1 for standard mode communication with peripherals.
void I2C_Init(void){
 ...
 */
// Read a single byte from the specified I2C slave register.
